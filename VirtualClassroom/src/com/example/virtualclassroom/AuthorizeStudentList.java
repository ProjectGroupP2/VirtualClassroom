...
public class AuthorizeStudentList extends ListActivity {
	private ProgressDialog pDialog;
    JSONParser jParser = new JSONParser();
    ArrayList<HashMap<String, String>> studentList;
    private static String url_approved_student_list = "http://10.0.2.2/VirtualClassroom/get_Approved_Student.php";
    private static String url_update_Student_Status = "http://10.0.2.2/VirtualClassroom/disable_student.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.authorize_student);
 
        studentList = new ArrayList<HashMap<String, String>>();
         new AuthorizeStudent().execute();
    ...
    class UpdateStatusOfStudent extends AsyncTask<String, String, String>
    {
         ...
         protected void onPreExecute() {
             super.onPreExecute();
             pDialog = new ProgressDialog(AuthorizeStudentList.this);
    ...
    class AuthorizeStudent extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            List<NameValuePair> params = new ArrayList<NameValuePair>();
            JSONObject json = jParser.makeHttpRequest(url_approved_student_list, "GET", params);
            Log.d("Subjects : ", json.toString());
             try {               
                int success = json.getInt(TAG_SUCCESS);
                 if (success == 1) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                	 ...
                	 ListAdapter adapter = new SimpleAdapter(
                             AuthorizeStudentList.this, studentList,
