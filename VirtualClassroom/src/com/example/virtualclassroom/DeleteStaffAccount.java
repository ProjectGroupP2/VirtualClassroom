...
public class DeleteStaffAccount extends Activity {
	private ProgressDialog pDialog;
	EditText username;
    JSONParser jsonParser = new JSONParser();
    private static final String TAG_SUCCESS = "success";
	private static String url_delete_account = "http://10.0.2.2/VirtualClassroom/delete_staff_account.php";
	 @Override
	 ...
	 class DeletAccount extends AsyncTask<String, String, String> 
	 {
		  @Override
	        protected void onPreExecute() {
	            super.onPreExecute();
	            pDialog = new ProgressDialog(DeleteStaffAccount.this);
