...
public class DisplayBookmarkSubjectList  extends ListActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
           ...
           public void onItemClick(AdapterView<?> parent, View view,
        	   ...
        	   Intent i = new Intent(getApplicationContext(),ShowPreviouslyPlayedVideos.class);
   ...
   class SubjectList extends AsyncTask<String, String, String> {
       ...
       protected void onPreExecute() {
           super.onPreExecute();
           pDialog = new ProgressDialog(DisplayBookmarkSubjectList.this);
           ...
           runOnUiThread(new Runnable() {
               public void run() {
               	 ...
               	 ListAdapter adapter = new SimpleAdapter(
               			DisplayBookmarkSubjectList.this, subjectList,
