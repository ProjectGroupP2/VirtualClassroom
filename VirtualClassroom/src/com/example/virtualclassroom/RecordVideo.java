...
public class RecordVideo extends Activity {
    ...
    private Button btnRecordVideo,btnUploadRecordVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUploadRecordVideo =  (Button) findViewById(R.id.btnUploadRecordVideo);
        btnUploadRecordVideo.setOnClickListener(new View.OnClickListener() {
