...
if (isset($_GET['username'])&& isset($_GET['securityQuestion'])&& isset($_GET['securityQuestionAnswer'])) {
 ...
 $securityQuestionAnswer = $_GET['securityQuestionAnswer'];
    ...
    $result = mysql_query("SELECT *FROM administratordetails WHERE username = '$username' AND securityQuestion='$securityQuestion' AND securityQuestionAnswer='$securityQuestionAnswer'");
